...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crowdataapp_documentsetformfield', (
            (u'field_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['forms.Field'], unique=True, primary_key=True)),
    ...
    models = {
        ...
        u'crowdataapp.documentsetformfield': {
            'Meta': {'ordering': "('order',)", 'object_name': 'DocumentSetFormField', '_ormbases': [u'forms.Field']},
            'autocomplete': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'field_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['forms.Field']", 'unique': 'True', 'primary_key': 'True'})
        },
