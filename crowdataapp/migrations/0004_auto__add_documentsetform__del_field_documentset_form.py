...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'crowdataapp_documentsetform', (
            ...
            ('document_set', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['crowdataapp.DocumentSet'])),
        ))
        db.send_create_signal(u'crowdataapp', ['DocumentSetForm'])

        # Deleting field 'DocumentSet.form'
        db.delete_column(u'crowdataapp_documentset', 'form_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DocumentSet.form'
        db.add_column(u'crowdataapp_documentset', 'form',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['forms.Form']),
                      keep_default=False)
