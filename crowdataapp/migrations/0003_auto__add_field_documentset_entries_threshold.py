...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DocumentSet.entries_threshold'
        db.add_column(u'crowdataapp_documentset', 'entries_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DocumentSet.entries_threshold'
        db.delete_column(u'crowdataapp_documentset', 'entries_threshold')
